...
3. Write Rego logic that iterates over the raw input payload (typically found under `input.findings["EVID-{{PROVIDER}}-{{SERVICE}}"]["{{PROVIDER}}"]`) and maps the nested properties to a flat dictionary structure.
