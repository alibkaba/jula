...
| **[Jula Compliance-as-Code](https://github.com/alibkaba/jula-governor)** | N/A | [Open Policy Agent (OPA)](https://www.openpolicyagent.org/) <br> Versioned Rego Rules | [![License](https://img.shields.io/badge/License-BSL_1.1-orange.svg)](LICENSE) |
...
* The **[Jula Compliance-as-Code](https://github.com/alibkaba/jula-governor) stores Rego policies** in a version-controlled repository that serves as the single source of truth for both dynamic resource normalization and compliance scoping rules.
...
flowchart TB
    ...
    subgraph Phase1 ["1. Compliance-as-Code Registry (jula-governor)"]
        direction LR
...
### 1. [Jula Compliance-as-Code](https://github.com/alibkaba/jula-governor) (The Compliance-as-Code Registry)
