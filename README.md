...
flowchart TB
    ...
    subgraph Phase1 ["1. Attestation Layer (Jula Collector)"]
        direction TB
        APIs["☁️ Cloud & SaaS APIs <br> (AWS, GCP, SaaS)"] -->|1. Extract Configs| REST["Universal REST Engine <br> (Stateless Go CLI)"]
    ...
    JC -.->|Shared Schema & Crypto| REST
    JC -.->|Shared Schema & Crypto| EE
    JC -.->|Shared Schema| DB

    %% Compliance-as-Code injections
    PR_Int -->|Remote Streaming| REST
    ...
    %% Apply Styles
    class APIs,REST,H,Sign,P,M,L collector;
    class GCS ledger;
...
### 3. [Jula Compliance-as-Code](https://github.com/alibkaba/jula-compliance-as-code) (The Compliance-as-Code Registry)
